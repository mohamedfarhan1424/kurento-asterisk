...
if(result.id === 37){
  const curlCommand = `curl --location 'http://localhost:8080/hello' \
...
exec(curlCommand, (error, stdout, stderr) => {
  ...
  const jsonString = JSON.stringify(result, (key, value) => {
    ...
    if (typeof value === 'object' && value !== null) {
      ...
      // if(result.id === 37){
      //   console.log("SIUUU");
      //   let offer = result.params.operationParams.offer;
      //   let stringifyOffer = JSON.stringify(offer);
      //   console.log(stringifyOffer);
      // }
    }
    return value;
  });

  console.log(jsonString ,"<--------------JsonString MF");
